...
def main():
    ...
    parser.add_argument("--backend", type=str, help="backend (gloo/nccl/mpi)")
    ...
    torch.distributed.init_process_group(backend=argv.backend)
    ...
    for epoch in range(num_epochs):
        ...
        # Save and evaluate model at the end of each epoch
        if local_rank == 0:
