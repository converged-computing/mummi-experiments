...
This will extend the [first test](../test-january-2025) of traditional Mummi to run the same setups with a state machine model. The same applies:
...
cd ./mummi-experiments/test-february-2025
```
...
```console
2025-02-01 21:54:06 [ℹ]  eksctl version 0.189.0-dev+c9afc4260.2024-08-27T16:08:34Z
2025-02-01 21:54:06 [ℹ]  using region us-east-1
2025-02-01 21:54:07 [ℹ]  subnets for us-east-1b - public:192.168.0.0/19 private:192.168.64.0/19
2025-02-01 21:54:07 [ℹ]  subnets for us-east-1c - public:192.168.32.0/19 private:192.168.96.0/19
2025-02-01 21:54:07 [ℹ]  nodegroup "workers" will use "" [AmazonLinux2/1.27]
2025-02-01 21:54:07 [ℹ]  using SSH public key "/home/vanessa/.ssh/id_eks.pub" as "eksctl-mini-mummi-gpu-nodegroup-workers-4e:93:d9:47:eb:81:3e:4f:1b:e0:44:ac:af:c6:ac:b3" 
2025-02-01 21:54:07 [ℹ]  using Kubernetes version 1.27
2025-02-01 21:54:07 [ℹ]  creating EKS cluster "mini-mummi-gpu" in "us-east-1" region with managed nodes
2025-02-01 21:54:07 [ℹ]  1 nodegroup (workers) was included (based on the include/exclude rules)
2025-02-01 21:54:07 [ℹ]  will create a CloudFormation stack for cluster itself and 0 nodegroup stack(s)
2025-02-01 21:54:07 [ℹ]  will create a CloudFormation stack for cluster itself and 1 managed nodegroup stack(s)
2025-02-01 21:54:07 [ℹ]  if you encounter any issues, check CloudFormation console or try 'eksctl utils describe-stacks --region=us-east-1 --cluster=mini-mummi-gpu'
2025-02-01 21:54:07 [ℹ]  Kubernetes API endpoint access will use default of {publicAccess=true, privateAccess=false} for cluster "mini-mummi-gpu" in "us-east-1"
2025-02-01 21:54:07 [ℹ]  CloudWatch logging will not be enabled for cluster "mini-mummi-gpu" in "us-east-1"
2025-02-01 21:54:07 [ℹ]  you can enable it with 'eksctl utils update-cluster-logging --enable-types={SPECIFY-YOUR-LOG-TYPES-HERE (e.g. all)} --region=us-east-1 --cluster=mini-mummi-gpu'
2025-02-01 21:54:07 [ℹ]  default addons vpc-cni, kube-proxy, coredns were not specified, will install them as EKS addons
2025-02-01 21:54:07 [ℹ]  
...
2025-02-01 21:54:07 [ℹ]  building cluster stack "eksctl-mini-mummi-gpu-cluster"
2025-02-01 21:54:08 [ℹ]  deploying stack "eksctl-mini-mummi-gpu-cluster"
2025-02-01 21:54:38 [ℹ]  waiting for CloudFormation stack "eksctl-mini-mummi-gpu-cluster"
2025-02-01 21:55:08 [ℹ]  waiting for CloudFormation stack "eksctl-mini-mummi-gpu-cluster"
2025-02-01 21:56:08 [ℹ]  waiting for CloudFormation stack "eksctl-mini-mummi-gpu-cluster"
2025-02-01 21:57:08 [ℹ]  waiting for CloudFormation stack "eksctl-mini-mummi-gpu-cluster"
2025-02-01 21:58:09 [ℹ]  waiting for CloudFormation stack "eksctl-mini-mummi-gpu-cluster"
2025-02-01 21:59:09 [ℹ]  waiting for CloudFormation stack "eksctl-mini-mummi-gpu-cluster"
2025-02-01 22:00:09 [ℹ]  waiting for CloudFormation stack "eksctl-mini-mummi-gpu-cluster"
2025-02-01 22:01:09 [ℹ]  waiting for CloudFormation stack "eksctl-mini-mummi-gpu-cluster"
2025-02-01 22:02:10 [ℹ]  waiting for CloudFormation stack "eksctl-mini-mummi-gpu-cluster"
2025-02-01 22:03:10 [ℹ]  waiting for CloudFormation stack "eksctl-mini-mummi-gpu-cluster"
2025-02-01 22:04:10 [ℹ]  waiting for CloudFormation stack "eksctl-mini-mummi-gpu-cluster"
2025-02-01 22:05:11 [ℹ]  waiting for CloudFormation stack "eksctl-mini-mummi-gpu-cluster"
2025-02-01 22:05:13 [!]  recommended policies were found for "vpc-cni" addon, but since OIDC is disabled on the cluster, eksctl cannot configure the requested permissions; the recommended way to provide IAM permissions for "vpc-cni" addon is via pod identity associations; after addon creation is completed, add all recommended policies to the config file, under `addon.PodIdentityAssociations`, and run `eksctl update addon`
2025-02-01 22:05:13 [ℹ]  creating addon
2025-02-01 22:05:13 [ℹ]  successfully created addon
2025-02-01 22:05:13 [ℹ]  creating addon
2025-02-01 22:05:14 [ℹ]  successfully created addon
2025-02-01 22:05:14 [ℹ]  creating addon
2025-02-01 22:05:15 [ℹ]  successfully created addon
2025-02-01 22:07:16 [ℹ]  building managed nodegroup stack "eksctl-mini-mummi-gpu-nodegroup-workers"
2025-02-01 22:07:17 [ℹ]  deploying stack "eksctl-mini-mummi-gpu-nodegroup-workers"
2025-02-01 22:07:17 [ℹ]  waiting for CloudFormation stack "eksctl-mini-mummi-gpu-nodegroup-workers"
2025-02-01 22:07:47 [ℹ]  waiting for CloudFormation stack "eksctl-mini-mummi-gpu-nodegroup-workers"
2025-02-01 22:08:34 [ℹ]  waiting for CloudFormation stack "eksctl-mini-mummi-gpu-nodegroup-workers"
2025-02-01 22:09:53 [ℹ]  waiting for CloudFormation stack "eksctl-mini-mummi-gpu-nodegroup-workers"
2025-02-01 22:11:16 [ℹ]  waiting for CloudFormation stack "eksctl-mini-mummi-gpu-nodegroup-workers"
2025-02-01 22:11:16 [ℹ]  waiting for the control plane to become ready
2025-02-01 22:11:16 [✔]  saved kubeconfig as "/home/vanessa/.kube/config"
2025-02-01 22:11:16 [ℹ]  1 task: { install Nvidia device plugin }
2025-02-01 22:11:16 [ℹ]  created "kube-system:DaemonSet.apps/nvidia-device-plugin-daemonset"
2025-02-01 22:11:16 [ℹ]  as you are using the EKS-Optimized Accelerated AMI with a GPU-enabled instance type, the Nvidia Kubernetes device plugin was automatically installed.
	to skip installing it, use --install-nvidia-plugin=false.
2025-02-01 22:11:16 [✔]  all EKS cluster resources for "mini-mummi-gpu" have been created
2025-02-01 22:11:16 [✔]  created 0 nodegroup(s) in cluster "mini-mummi-gpu"
2025-02-01 22:11:17 [ℹ]  nodegroup "workers" has 6 node(s)
2025-02-01 22:11:17 [ℹ]  node "ip-192-168-12-193.ec2.internal" is ready
2025-02-01 22:11:17 [ℹ]  node "ip-192-168-18-188.ec2.internal" is ready
2025-02-01 22:11:17 [ℹ]  node "ip-192-168-22-46.ec2.internal" is ready
2025-02-01 22:11:17 [ℹ]  node "ip-192-168-24-170.ec2.internal" is ready
2025-02-01 22:11:17 [ℹ]  node "ip-192-168-28-106.ec2.internal" is ready
2025-02-01 22:11:17 [ℹ]  node "ip-192-168-29-195.ec2.internal" is ready
2025-02-01 22:11:17 [ℹ]  waiting for at least 6 node(s) to become ready in "workers"
2025-02-01 22:11:17 [ℹ]  nodegroup "workers" has 6 node(s)
2025-02-01 22:11:17 [ℹ]  node "ip-192-168-12-193.ec2.internal" is ready
2025-02-01 22:11:17 [ℹ]  node "ip-192-168-18-188.ec2.internal" is ready
2025-02-01 22:11:17 [ℹ]  node "ip-192-168-22-46.ec2.internal" is ready
...
2025-02-01 22:11:17 [ℹ]  node "ip-192-168-28-106.ec2.internal" is ready
2025-02-01 22:11:17 [ℹ]  node "ip-192-168-29-195.ec2.internal" is ready
2025-02-01 22:11:17 [✔]  created 1 managed nodegroup(s) in cluster "mini-mummi-gpu"
2025-02-01 22:11:17 [✖]  getting Kubernetes version on EKS cluster: error running `kubectl version`: exit status 1 (check 'kubectl version')
2025-02-01 22:11:17 [ℹ]  cluster should be functional despite missing (or misconfigured) client binaries
2025-02-01 22:11:17 [✔]  EKS cluster "mini-mummi-gpu" in "us-east-1" region is ready
```
